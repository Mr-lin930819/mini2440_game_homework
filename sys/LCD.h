...
// BMPÍ¼Æ¬
extern unsigned char indexs[];		// Ê×Ò³
extern unsigned char bg[];			// ±³¾°Ò³
extern unsigned char Loffy1[];		// ÏÔÊ¾Í¼Æ¬1
extern unsigned char Loffy2[];		// ÏÔÊ¾Í¼Æ¬2
extern unsigned char main_img[];		// ÊµÑéÍ¼Æ¬
